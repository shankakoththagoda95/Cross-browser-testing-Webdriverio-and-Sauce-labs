...
```
cd existing_repo
git remote add origin https://gitlab.com/shankakoththagoda/cross-browser-testing-webdriverio-and-sauce-labs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/shankakoththagoda/cross-browser-testing-webdriverio-and-sauce-labs/-/settings/integrations)
